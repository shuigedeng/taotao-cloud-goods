 ...
 * 商品关键词持久化仓储接口
 * <p>
 * 继承 JPA BaseRepository 和 ExtendRepository，提供商品关键词 PO 的基础 CRUD 操作
 * </p>
 *
 * @author shuigedeng
 */
public interface GoodsWordsRepository
        extends BaseRepository<GoodsWordsPO>,
				ExtendRepository<GoodsWordsPO, Long> {}
