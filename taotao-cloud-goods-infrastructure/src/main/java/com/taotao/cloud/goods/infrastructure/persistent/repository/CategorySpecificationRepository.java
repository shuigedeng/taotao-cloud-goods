 ...
 * 商品分类规格持久化仓储接口
 * <p>
 * 继承 JPA BaseRepository 和 ExtendRepository，提供商品分类规格 PO 的基础 CRUD 操作
 * </p>
 *
 * @author shuigedeng
 */
public interface CategorySpecificationRepository
        extends BaseRepository<CategorySpecificationPO>,
                ExtendRepository<CategorySpecificationPO, Long> {}
