 ...
 * 商品相册持久化仓储接口
 * <p>
 * 继承 JPA BaseRepository 和 ExtendRepository，提供商品相册 PO 的基础 CRUD 操作
 * </p>
 *
 * @author shuigedeng
 */
public interface GoodsGalleryRepository
        extends BaseRepository<GoodsGalleryPO>,
                ExtendRepository<GoodsGalleryPO, Long> {}
