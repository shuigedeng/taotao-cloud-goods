...
import com.taotao.cloud.goods.infrastructure.persistent.persistence.dept.persistence.DeptPO;
 ...
 */
public interface IDeptRepository extends BaseInterfaceSuperRepository<com.taotao.cloud.goods.infrastructure.persistent.persistence.DeptPO, Long> {

    @Query("select d from DeptPO d where d.version <> ?1")
		com.taotao.cloud.goods.infrastructure.persistent.persistence.DeptPO findByVersionNot(Integer version);
    ...
    @Query(
			...
			""",
            nativeQuery = true)
		com.taotao.cloud.goods.infrastructure.persistent.persistence.DeptPO find(@Param("deptPO") com.taotao.cloud.goods.infrastructure.persistent.persistence.DeptPO deptPO);
    //
    // @Query(value = """
