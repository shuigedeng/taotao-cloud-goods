...
public abstract class FlowHandler {
     ...
     * 获取对应的处理器
     *
     * @param flowHandlerInfo 处理器信息
     * @return Handler
     */
    protected abstract Handler getHandler(FlowHandlerInfo flowHandlerInfo);  // 需要子类实现
	...
	public void registerHandler(FlowHandlerInfo flowHandlerInfo, Handler handler) {  // 重命名避免歧义
