...
public record GoodsSkuResult(
	...
	@Schema(description = "促销价") BigDecimal promotionPrice,
	@Schema(description = "商品名称") String goodsName,
	@Schema(description = "商品编号") String sn, @Schema(description = "品牌id") Long brandId,
	...
	@Schema(description = "成本价格") BigDecimal cost,
	@Schema(description = "浏览数量") Integer viewCount,
	@Schema(description = "购买数量") Integer buyCount,
	@Schema(description = "库存") Integer quantity,
	@Schema(description = "商品好评率") BigDecimal grade,
	...
	@Schema(description = "商品类型") String goodsType) implements MarkerResult {
