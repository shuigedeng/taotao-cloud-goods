...
package com.taotao.cloud.goods.application.support.handler.pie.category;
...
public class ArticleModifyBootstrap {
    ...
    public void test() {
        ...
        // // 第二个handler
        //                .addChannelHandlerAtLast("modifyContent", new
        // ArticleModifyContentHandler()) // 第三个handler
