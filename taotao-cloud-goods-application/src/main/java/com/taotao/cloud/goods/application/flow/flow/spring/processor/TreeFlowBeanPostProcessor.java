...
import com.taotao.cloud.goods.application.flow.flow.spring.service.FlowHandlerInfoProxy;
...
public class TreeFlowBeanPostProcessor implements BeanPostProcessor, ApplicationContextAware {
	...
	public void setApplicationContext( ApplicationContext applicationContext) throws BeansException {
		...
		Map<String, BusinessHandler> businessHandlerMap = this.applicationContext.getBeansOfType(BusinessHandler.class);
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		...
		for (Method declaredMethod : declaredMethods) {
			FlowHandlerInst flowHandlerInst = declaredMethod.getAnnotation(FlowHandlerInst.class);
			if (null != flowHandlerInst) {
