...
import com.taotao.cloud.goods.application.command.dept.dto.DeptListQry;
import com.taotao.cloud.goods.application.command.dept.dto.DeptModifyCmd;
import com.taotao.cloud.goods.application.command.dept.dto.DeptRemoveCmd;
import com.taotao.cloud.goods.application.command.dept.dto.clientobject.DeptCO;
import com.taotao.cloud.goods.application.command.dept.executor.DeptCreateCmdExe;
import com.taotao.cloud.goods.application.command.dept.executor.DeptModifyCmdExe;
import com.taotao.cloud.goods.application.command.dept.executor.DeptRemoveCmdExe;
