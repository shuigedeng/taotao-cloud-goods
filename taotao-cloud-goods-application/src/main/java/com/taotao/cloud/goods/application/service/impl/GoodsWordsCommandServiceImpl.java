 ...
 */
@Service
public class GoodsWordsCommandServiceImpl
        extends BaseSuperServiceImpl<GoodsWordsPO, Long, GoodsWordsMapper, GoodsWordsRepository, IGoodsWordsRepository>
        implements GoodsWordsCommandService {}
