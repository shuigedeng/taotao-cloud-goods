...
public record GoodsResult(
	@Schema(description = "商品参数json") Long id,
	...
	@Schema(description = "商品卖点太长") String sellingPoint,
	...
	@Schema(description = "商品海报id") Long posterPicId,
	@Schema(description = "商品类型") String goodsType,
	@Schema(description = "商品参数json") String params,
	@Schema(description = "商品参数json") Boolean delFlag) implements
	MarkerResult {
