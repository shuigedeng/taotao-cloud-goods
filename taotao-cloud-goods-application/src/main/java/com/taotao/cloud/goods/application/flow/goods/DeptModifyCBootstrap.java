...
package com.taotao.cloud.goods.application.flow.goods;

import com.taotao.boot.common.support.pie.BootStrap;
import com.taotao.cloud.goods.application.flow.goods.handlers.ArticleModifyContentHandler;
import com.taotao.cloud.goods.application.flow.goods.handlers.ArticleModifyTitleHandler;
import com.taotao.cloud.goods.application.flow.goods.handlers.CheckParameterHandler;
...
public class DeptModifyCBootstrap {
    ...
    public void start() {
        // 入参
        GoodsContext goodsContext = new GoodsContext();
        // 创建引导类
