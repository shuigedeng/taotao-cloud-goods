...
import com.taotao.cloud.goods.application.pie.dict.ArticleTitleModifyCmd;
...
public class DeptBootstrap {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DeptBootstrap.class);
