...
`taotao-cloud` (taotao云平台) 基于gradle8.11、jdk21, 支持graalvm21, 采用最新的spring 6.1.14、SpringBoot 3.3.5、SpringCloud 2023.0.3、SpringSecurity 6.3.4、Nacos 2.4.3、Mybatis-Plus 3.5.9、Redis 7.4.0等框架，开发的一款企业级微服务架构的云服务平台，
