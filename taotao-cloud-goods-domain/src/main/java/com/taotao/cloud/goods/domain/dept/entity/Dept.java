...
import com.taotao.cloud.goods.domain.dept.valueobject.ContentVal;
import com.taotao.cloud.goods.domain.dept.valueobject.MessageCategoryVal;
import com.taotao.cloud.goods.domain.dept.valueobject.UserVal;
...
public class Dept extends AggregateRoot<Long> {
	...
	protected Dept(Long aLong, MessageCategoryVal category, UserVal sender, UserVal receiver, ContentVal content) {
		super(aLong);
