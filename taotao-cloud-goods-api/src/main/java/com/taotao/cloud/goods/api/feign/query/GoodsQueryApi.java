...
package com.taotao.cloud.goods.api.feign.query;

import com.taotao.boot.common.constant.ServiceNameConstants;
import com.taotao.boot.common.model.request.Request;
import com.taotao.boot.common.model.response.Response;
import com.taotao.cloud.goods.api.feign.command.fallback.GoodsCommandApiFallback;
...
@FeignClient(
	contextId = "GoodsApi",
        ...
        fallbackFactory = GoodsCommandApiFallback.class)
