...
public final class BaseCommand {
	...
	@Data
	public static class CreditLimitInfo implements Command {
	...
	@Data
	public static class AdjustLimitInfo implements Command {
	...
	@Data
	public static class CapitalInfo implements Command {
