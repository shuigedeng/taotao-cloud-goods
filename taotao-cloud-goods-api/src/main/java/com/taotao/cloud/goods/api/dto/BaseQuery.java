...
public final class BaseQuery {
	...
	@Data
	public static class CreditLimitInfo implements Query {
	...
	@Data
	public static class AdjustLimitInfo implements Query {
	...
	@Data
	public static class CapitalInfo implements Query {
