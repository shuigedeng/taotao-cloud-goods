...
@WebMvcTest(SellerCategoryParameterGroupController.class)
public class CategoryParameterGroupSellerControllerTest {
	...
	class QueryByCategoryId {
		...
		@Test
		void shouldReturnParameterGroupsWhenCategoryExists() throws Exception {
			ParameterGroupResult group = ParameterGroupResultBuilder.builder()
				.groupId(1L)
				.groupName("基本参数")
				.build();
			...
			mockMvc.perform(get("/seller/goods/category/parameters/query/category-id")
					.param("categoryId", "1"))
