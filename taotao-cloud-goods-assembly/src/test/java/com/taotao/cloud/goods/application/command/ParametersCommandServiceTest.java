...
/**
 * ParametersCommandService 集成测试
 *
 * @author shuigedeng
 * @version 2026.04
 * @since 2026-08-22
 */
class ParametersCommandServiceTest extends TaoTaoCloudGoodsApplicationTests {
    ...
    class BeanInjection {
        ...
        void shouldInjectServiceBean() {
            assertThat(parametersCommandService).isNotNull();
        }

        @Test
        void shouldBeInstanceOfParametersCommandService() {
            assertThat(parametersCommandService).isInstanceOf(ParametersCommandService.class);
        }
    }
}
