 ...
 */
@DisplayName("商品命令RPC服务集成测试")
class GoodsCommandRpcServiceImplTest extends TaoTaoCloudGoodsApplicationTests {

    @Autowired
    private GoodsCommandRpcService goodsCommandRpcService;

    @Test
    @DisplayName("服务可以正常注入")
    void shouldInjectService() {
        assertThat(goodsCommandRpcService).isNotNull();
    }
