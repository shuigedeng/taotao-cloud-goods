...
/**
 * GoodsUnitCommandService 集成测试
 *
 * @author shuigedeng
 * @version 2026.04
 * @since 2026-08-22
 */
class GoodsUnitCommandServiceTest extends TaoTaoCloudGoodsApplicationTests {
    ...
    class BeanInjection {
        ...
        void shouldInjectServiceBean() {
            assertThat(goodsUnitCommandService).isNotNull();
        }

        @Test
        void shouldBeInstanceOfGoodsUnitCommandService() {
            assertThat(goodsUnitCommandService).isInstanceOf(GoodsUnitCommandService.class);
        }
    }
}
